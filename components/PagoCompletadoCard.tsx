    ...
    return (
        <Card className="bg-white col-span-2 lg:col-span-4 dark:bg-black shadow-lg rounded-lg overflow-hidden">
            ...
            <CardContent className="p-4">
                ...
                <div className="flex items-center justify-start mb-2">
                    <span className="font-medium text-gray-600 mr-4 dark:text-gray-200">Importe:</span>
                    <span className="text-gray-600 font-bold dark:text-gray-200">{data.importe}</span>
                </div>
            </CardContent>
