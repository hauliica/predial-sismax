  ...
  return (
      <Card className="bg-white col-span-2 lg:col-span-4 dark:bg-black shadow-lg rounded-lg overflow-hidden">
        ...
        <CardContent className="p-4">
          ...
          <span className="font-medium mr-4 text-gray-600 dark:text-gray-200">
            Fecha:
          </span>
            <span className="text-gray-600 font-bold dark:text-gray-200">
            {paymentDate}
          </span>
          </div>
          <div className="flex justify-start mb-2">
          ...
          <span className="font-medium text-gray-600 mr-4 dark:text-gray-200">
            Numero de Control:
          </span>
            <span className="text-gray-600 font-bold dark:text-gray-200">
            {data.numeroControl}
        ...
        {/*    Descargar Recibo*/}
        {/*  </Button>*/}
        {/*  <Button variant="outline">Ver Detalles de la Transacción</Button>*/}
        {/*</CardFooter>*/}
      </Card>
  );
}
